...
from svnlit.markup.hightlighter import get_lexer, make_html
from svnlit.utils.binaryornot import get_starting_chunk, is_binary_string
...
class Repository(models.Model):
    ...
    prefix = models.CharField(
        help_text=_('The prefix of repository if it is existed'),
...
class Content(models.Model):
    ...
    def get_data_display(self):
        ...
        #     highlight(txt, lexer, HtmlFormatter(linenos=True, style='emacs', cssclass='codehilite')))
